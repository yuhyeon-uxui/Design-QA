...
/**
     ...
     * limitations under the License.
     */
class W{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===t?.type}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const J="@firebase/app",K="0.16.1",G=new D("@firebase/app"),X="@firebase/app-compat",Y="@firebase/analytics-compat",Z="@firebase/analytics",Q="@firebase/app-check-compat",ee="@firebase/app-check",te="@firebase/auth",ne="@firebase/auth-compat",re="@firebase/database",ie="@firebase/data-connect",ae="@firebase/database-compat",oe="@firebase/functions",se="@firebase/functions-compat",ce="@firebase/installations",le="@firebase/installations-compat",ue="@firebase/messaging",fe="@firebase/messaging-compat",de="@firebase/performance",pe="@firebase/performance-compat",he="@firebase/remote-config",ge="@firebase/remote-config-compat",me="@firebase/storage",be="@firebase/storage-compat",ve="@firebase/firestore",ye="@firebase/ai",_e="@firebase/firestore-compat",we="firebase",Ee="[DEFAULT]",Se={[J]:"fire-core",[X]:"fire-core-compat",[Z]:"fire-analytics",[Y]:"fire-analytics-compat",[ee]:"fire-app-check",[Q]:"fire-app-check-compat",[te]:"fire-auth",[ne]:"fire-auth-compat",[re]:"fire-rtdb",[ie]:"fire-data-connect",[ae]:"fire-rtdb-compat",[oe]:"fire-fn",[se]:"fire-fn-compat",[ce]:"fire-iid",[le]:"fire-iid-compat",[ue]:"fire-fcm",[fe]:"fire-fcm-compat",[de]:"fire-perf",[pe]:"fire-perf-compat",[he]:"fire-rc",[ge]:"fire-rc-compat",[me]:"fire-gcs",[be]:"fire-gcs-compat",[ve]:"fire-fst",[_e]:"fire-fst-compat",[ye]:"fire-vertex","fire-js":"fire-js",[we]:"fire-js-all"},Ie=new Map,Te=new Map,Ce=new Map;function Ae(e,t){try{e.container.addComponent(t)}catch(n){G.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function De(e){const t=e.name;if(Ce.has(t))return G.debug(`There were multiple attempts to register component ${t}.`),!1;Ce.set(t,e);for(const t of Ie.values())Ae(t,e);for(const t of Te.values())Ae(t,e);return!0}function Ne(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}function ke(e){return void 0!==e.options}function Oe(e){return!ke(e)&&("authIdToken"in e||"appCheckToken"in e||"releaseOnDeref"in e||"automaticDataCollectionEnabled"in e)}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
function(e){xe("@firebase/app-compat","0.5.17",e)}("lite");
/**
     * @license
...
/**
     ...
     * limitations under the License.
     */
var ri;(ri=nt).INTERNAL.registerComponent(new v("performance-compat",ni,"PUBLIC")),ri.registerVersion("@firebase/performance-compat","0.2.27");
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
return nt.registerVersion("firebase","12.18.0","compat-lite"),nt}));
